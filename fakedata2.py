...
VEHICLE_DATA = {
    ...
    'Volkswagen': {
        ...
        'Campervan': ['California']
    },
    'BMW': {
        'Sedan': ['3 Series', '5 Series'],
        'Hatchback': ['1 Series'],
        'SUV': ['X1', 'X3', 'X5'],
        'Motorcycle': ['R 1250 GS', 'S 1000 RR']
    },
    'Mercedes-Benz': {
        'Hatchback': ['A-Class'],
    ...
    'Toyota': {
        ...
        'Sedan': ['Prius'], # Prius can also be considered a liftback, but categorizing as Sedan for simplicity
        'SUV': ['C-HR', 'RAV4'],
        'Truck': ['Hilux'],
        'Bus': ['Coaster']
    },
    'Land Rover': {
        'SUV': ['Defender', 'Discovery', 'Range Rover Evoque', 'Range Rover']
    },
    'Jaguar': {
        'Sedan': ['XE', 'XF'],
        'SUV': ['E-PACE', 'F-PACE']
    ...
    'Volvo': {
        'Sedan': ['S60', 'S90'],
        'Estate': ['V60', 'V90'], # Added Estate as a car body type
        'SUV': ['XC40', 'XC60', 'XC90'],
        'Lorry': ['FH Series'],
        'Bus': ['Buses']
    },
    'Scania': {
        'Lorry': ['R-series', 'S-series'],
        'Bus': ['Citywide']
    },
    'DAF': {
        'Lorry': ['XF', 'CF']
    ...
    'Renault': {
        'Hatchback': ['Clio', 'Megane'], # Added Megane
        'SUV': ['Captur', 'Kadjar'], # Added Kadjar
        'Van': ['Trafic', 'Master'],
        'Lorry': ['T-Series']
    },
    'Peugeot': {
        'Hatchback': ['208', '308'],
        'SUV': ['2008', '3008', '5008'], # Added 5008
        'Van': ['Partner', 'Boxer']
    },
    'Citroen': {
        'Hatchback': ['C3', 'C4'],
        'SUV': ['C3 Aircross', 'C5 Aircross'], # Added C5 Aircross
        'Van': ['Berlingo', 'Dispatch']
    },
    'Fiat': {
        'Hatchback': ['500', 'Panda'],
        'Van': ['Ducato', 'Talento'],
        'Campervan': ['Ducato-based RV']
    },
    'KTM': {
        'Motorcycle': ['Duke', 'Adventure']
    },
    'Honda': {
        'Hatchback': ['Civic'],
        'SUV': ['CR-V'],
        'Motorcycle': ['CB1000R', 'Africa Twin']
    },
    'Skoda': { # Added Skoda
        'Hatchback': ['Fabia', 'Octavia'],
        'Sedan': ['Superb'],
        'SUV': ['Kamiq', 'Karoq', 'Kodiaq']
    },
    'Hyundai': { # Added Hyundai
        'Hatchback': ['i10', 'i20', 'i30'],
        'SUV': ['Kona', 'Tucson', 'Santa Fe']
    },
    'Kia': { # Added Kia
        'Hatchback': ['Picanto', 'Ceed'],
        'SUV': ['Stonic', 'Sportage', 'Sorento']
    }
}
...
GARAGE_TYPES = ['Independent', 'Franchise', 'Chain', 'Mobile']
